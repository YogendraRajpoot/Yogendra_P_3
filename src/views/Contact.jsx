    ...
    >
      <div className="max-w-7xl mx-auto x-4 sm:px-6 lg:px-8 px-4 ">
        ...
        <div className="flex justify-between items-center md:items-stretch  flex-col md:flex-row pb-24 ">
          <div className="w-full md:pr-8 flex flex-col items-center justify-evenly">
            {/* <form>
              <div class="my-6">
                <label
                  for="name"
              ...
              <div className="flex justify-between ">
                ...
                <button className="bg-indigo-500 text-white px-4 py-2 w-40 rounded-md hover:bg-indigo-400">
                  <a href="mailto:yogendrarajpooten1030@gmail.com">Submit</a>
                </button>
              </div>
            </form> */}
            {/* ***********************add**************************/}
          ...
          <div className="w-full flex flex-col md:items-end  mt-12 md:mt-6">
            ...
            <a
              href="hello"
              className="mb-12 mt-4 font-bold text-blue-700 block "
            >
              yogendrarajpooten1030@gmail.com
            </a>
            <h1 className="text-3xl  font-bold">Address</h1>
            <a
              href="hello"
              className="mt-4  mb-12 md:text-right font-bold text-blue-700 block "
            >
              Bengaluru,Karnataka
              <br />
              India
